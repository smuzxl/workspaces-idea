...
public class StringUtil {
    public static final String upper = "ABCDEFGHJKLMNPQRSTUVWXYZ";// O,Iȥ��
    public static final String lower = "abcdefghijkmnpqrstuvwxyz";// o,lȥ��
    ...
    public static String getRandomString(int length, boolean includeUpper, boolean includeLower, boolean includeDigital) {
        ...
        if (includeDigital)
            s += digital;
        if (length > 100) {
            throw new IllegalArgumentException("��ɵ��ַ��ȱ���<100��");
        }
    ...
    /**
     * ���max����, count�����ظ������ eg. getRandomNumber(20, 6) ���20����6�����ظ������
     * 2011-02-23 bobo
     */
